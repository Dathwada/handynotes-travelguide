...
constants.defaults = {
    profile = {
        icon_scale_config_portal = 1.5,
        icon_alpha_config_portal = 1.0,
        icon_scale_config_boat = 1.5,
        icon_alpha_config_boat = 1.0,
        icon_scale_config_zeppelin = 1.5,
        icon_alpha_config_zeppelin = 1.0,
        icon_scale_config_covenant = 1.3,
        icon_alpha_config_covenant = 1.0,
        icon_scale_config_others = 1.5,
        icon_alpha_config_others = 1.0,
