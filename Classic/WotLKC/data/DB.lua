...
---------------------------------------------------------Vanilla---------------------------------------------------------
    ...
    [1437] = { -- Wetlands
        ...
        [04635710] = { icon="boat", label=BtoBoreanTundra, note=Valgarde, faction="Alliance" },
        [04635711] = { icon="aboat", label=BtoBoreanTundra, note=Valgarde, faction="Horde" }
        },
    [1414] = { -- Kalimdor
...
--        [44152601] = { icon="aboat", label=BtoMenethilHarbor, note=Wetlands, faction="Horde" },
    ...
    [1415] = { -- Eastern Kingdom
        ...
        [45995488] = { icon="aboat", multilabel={BtoTheramore, BtoBoreanTundra}, multinote={DustwallowMarsh, Valgarde}, faction="Horde" },
        [45995482] = { icon="boat", multilabel={BtoTheramore, BtoBoreanTundra}, multinote={DustwallowMarsh, Valgarde}, faction="Alliance" },
...
---------------------------------------------------------WotLKC----------------------------------------------------------
    ...
    [113] = { -- Northrend
        ...
        [80768453] = { icon="boat", label=BtoMenethilHarbor, note=Wetlands, faction="Alliance" },
